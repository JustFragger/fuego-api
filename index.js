...
const MAX_MIXIN = 10;
const MIN_MIXIN = 2;
const DEFAULT_UNLOCK_HEIGHT = 60;
const DEFAULT_FEE = 80000; // raw X
const DEFAULT_CHARACTER_FEE = 8000; // raw X
...
const err = {
  ...
  addr: ' must be 98-character string beginning with fireXXX',
  intAddr:  ' must be 186-character string beginning with fireXXX',
  raw: ' must be a raw amount of XFG (X)',
  trans: ' must be a transfer object { address: 98-character string beginning with XFG, amount: raw amount of XFG (X), message: optional string }',
...
XFG.prototype.outputs = function () {
  return new Promise((resolve, reject) => {
    wrpc(this, 'get_outputs', {}, resolve, reject);
  });
};

XFG.prototype.height = function () {
  return new Promise((resolve, reject) => {
    wrpc(this, 'get_height', {}, resolve, reject);
  });
};

XFG.prototype.balance = function () {
  return new Promise((resolve, reject) => {
    wrpc(this, 'getbalance', {}, resolve, reject);
  });
};

XFG.prototype.messages = function (opts) {
  return new Promise((resolve, reject) => {
...
XFG.prototype.payments = function (paymentId) { // incoming payments
  return new Promise((resolve, reject) => {
...
XFG.prototype.transfers = function () {
  return new Promise((resolve, reject) => {
    wrpc(this, 'get_transfers', {}, resolve, reject);
  });
};

XFG.prototype.store = function () {
  return new Promise((resolve, reject) => {
    wrpc(this, 'store', {}, resolve, reject);
  });
};

XFG.prototype.reset = function () {
  return new Promise((resolve, reject) => {
    wrpc(this, 'reset', {}, resolve, reject);
  });
};

XFG.prototype.optimize = function () {
  return new Promise((resolve, reject) => {
    wrpc(this, 'optimize', {}, resolve, reject);
  });
};

XFG.prototype.send = function (opts) {
  return new Promise((resolve, reject) => {
...
XFG.prototype.resetOrReplace = function (viewSecretKey) {
  return new Promise((resolve, reject) => {
...
XFG.prototype.status = function () {
  return new Promise((resolve, reject) => {
    wrpc(this, 'getStatus', {}, resolve, reject);
  });
};

XFG.prototype.getBalance = function (address) {
  return new Promise((resolve, reject) => {
...
XFG.prototype.createAddress = function () {
  return new Promise((resolve, reject) => {
    wrpc(this, 'createAddress', {}, resolve, reject);
  });
};

XFG.prototype.createIntegrated = function (address, paymentId) {
    return new Promise((resolve, reject) => {
      if (isUndefined(address) || !isAddress(address)) reject('address' + err.addr);
...
XFG.prototype.deleteAddress = function (address) {
  return new Promise((resolve, reject) => {
    if (isUndefined(address) || !isAddress(address)) reject('address' + err.addr);
...
XFG.prototype.getAddresses = function () {
  return new Promise((resolve, reject) => {
    wrpc(this, 'getAddresses', {}, resolve, reject);
  });
};

XFG.prototype.getViewSecretKey = function () {
  return new Promise((resolve, reject) => {
    wrpc(this, 'getViewKey', {}, resolve, reject);
  });
};

XFG.prototype.getSpendKeys = function (address) {
  return new Promise((resolve, reject) => {
    if (isUndefined(address) || !isAddress(address)) reject('address' + err.addr);
...
XFG.prototype.getBlockHashes = function (firstBlockIndex, blockCount) {
  return new Promise((resolve, reject) => {
...
XFG.prototype.getTransaction = function (hash) {
  return new Promise((resolve, reject) => {
...
XFG.prototype.getUnconfirmedTransactionHashes = function (addresses) {
  return new Promise((resolve, reject) => {
...
XFG.prototype.getTransactionHashes = function (opts) {
  return new Promise((resolve, reject) => {
    if (!isObject(opts)) reject(err.opts);
...
XFG.prototype.getTransactions = function (opts) {
  return new Promise((resolve, reject) => {
    if (!isObject(opts)) reject(err.opts);
    else if (!isNonNegative(opts.blockCount)) reject('blockCount' + err.nonNeg);
    else if (isUndefined(opts.firstBlockIndex) && isUndefined(opts.blockHash)) reject('either firstBlockIndex or blockHash is required');
...
XFG.prototype.sendTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    if (!isObject(opts)) reject(err.opts);
    else if (isUndefined(opts.transfers) || !arrayTest(opts.transfers, isTransfer)) reject('transfers' + err.arr + ' of transfers each of which' + err.trans);
    else if (!isUndefined(opts.addresses) && !arrayTest(opts.addresses, isAddress)) reject('addresses' + err.arr + ' of addresses each of which' + err.addr);
...
XFG.prototype.createDelayedTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    if (!isObject(opts)) reject(err.opts);
    else if (isUndefined(opts.transfers) || !arrayTest(opts.transfers, isTransfer)) reject('transfers' + err.arr + ' of transfers each of which' + err.trans);
    else if (!isUndefined(opts.addresses) && !arrayTest(opts.addresses, isAddress)) reject('addresses' + err.arr + ' of addresses each of which' + err.addr);
...
XFG.prototype.getDelayedTransactionHashes = function () {
  return new Promise((resolve, reject) => {
    wrpc(this, 'getDelayedTransactionHashes', {}, resolve, reject);
  });
};

XFG.prototype.deleteDelayedTransaction = function (hash) {
  return new Promise((resolve, reject) => {
    if (!isHex64String(hash)) reject('hash' + err.hex64);
...
XFG.prototype.sendDelayedTransaction = function (hash) {
  return new Promise((resolve, reject) => {
    if (!isHex64String(hash)) reject('hash' + err.hex64);
...
XFG.prototype.getMessagesFromExtra = function (extra) {
  return new Promise((resolve, reject) => {
...
XFG.prototype.createDeposit = function (opts) {
  return new Promise((resolve, reject) => {
    if (!isObject(opts)) reject(err.opts);
...
XFG.prototype.withdrawDeposit = function (depositId) {
  return new Promise((resolve, reject) => {
...
XFG.prototype.count = function () {
  return new Promise((resolve, reject) => {
    drpc(this, 'getblockcount', {}, resolve, reject);
  });
};

XFG.prototype.blockHashByHeight = function (height) {
  return new Promise((resolve, reject) => {
...
XFG.prototype.blockHeaderByHash = function (hash) {
  return new Promise((resolve, reject) => {
    if (!isHex64String(hash)) reject('hash' + err.hex64);
...
XFG.prototype.blockHeaderByHeight = function (height) {
  return new Promise((resolve, reject) => {
    if (!isNonNegative(height)) reject('height' + err.nonNeg);
...
XFG.prototype.lastBlockHeader = function () {
  return new Promise((resolve, reject) => {
    drpc(this, 'getlastblockheader', {}, resolve, reject);
  });
};

XFG.prototype.block = function (hash) {
  return new Promise((resolve, reject) => {
    if (!isHex64String(hash)) reject('hash' + err.hex64);
...
XFG.prototype.blocks = function (height) {
  return new Promise((resolve, reject) => {
    if (!isNonNegative(height)) reject('height' + err.nonNeg);
...
XFG.prototype.transaction = function (hash) {
  return new Promise((resolve, reject) => {
    if (!isHex64String(hash)) reject('hash' + err.hex64);
...
XFG.prototype.transactionPool = function () {
  return new Promise((resolve, reject) => {
    drpc(this, 'f_on_transactions_pool_json', {}, resolve, reject);
  });
};

XFG.prototype.currencyId = function () {
  return new Promise((resolve, reject) => {
    drpc(this, 'getcurrencyid', {}, resolve, reject);
  });
};

XFG.prototype.blockTemplate = function (opts) {
  return new Promise((resolve, reject) => {
    if (!isObject(opts)) reject(err.opts);
...
XFG.prototype.submitBlock = function (block) {
  return new Promise((resolve, reject) => {
...
XFG.prototype.info = function () {
  return new Promise((resolve, reject) => {
    hrpc(this, {}, '/getinfo', resolve, reject);
  });
};

XFG.prototype.index = function () {
  return new Promise((resolve, reject) => {
    hrpc(this, {}, '/getheight', resolve, reject);
  });
};

XFG.prototype.transactions = function (txs) {
  return new Promise((resolve, reject) => {
...
XFG.prototype.sendRawTransaction = function (rawTx) {
  return new Promise((resolve, reject) => {
...
XFG.prototype.estimateFusion = function (opts) {
  return new Promise((resolve, reject) => {
    if (!isObject(opts)) reject(err.opts);
...
XFG.prototype.sendFusionTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    if (!isObject(opts)) reject(err.opts);
    else if (isUndefined(opts.threshold) || !isNonNegative(opts.threshold)) reject('threshold' + err.nonNeg);
    else if (!isUndefined(opts.addresses) && !arrayTest(opts.addresses, isAddress)) reject('addresses' + err.arr + ' of addresses each of which' + err.addr);
...
function isAddress(str) { return (typeof str === 'string' && str.length === 98 && str.slice(0, 4) === 'fire'); }

function isIntAddress(str) { return (typeof str === 'string' && str.length === 186 && str.slice(0, 4) === 'fire'); }
